...
import { Lock, Bell, Trash2, AlertTriangle, Save, Check, X } from 'lucide-react';
...
const VendorSettings: React.FC = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      // In a real app, you would delete the vendor account in Supabase here
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-400"
                    />
                    <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">New messages from customers</span>
                  </label>
